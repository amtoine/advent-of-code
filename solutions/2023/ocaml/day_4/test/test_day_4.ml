...
let () =
    Alcotest.run "Day 4: Scratchcards" [
        "examples", [
            "silver", `Quick, test Day_4.silver (Day_4__Fs.read_file (data_dir ^ "silver.txt")) 13;
            "amtoine-silver", `Quick, test Day_4.silver (Day_4__Fs.read_file (data_dir ^ "amtoine.txt")) 28750;
